...
variable "exporter_image" {
  description = "The type of exporter instance. The instance type will dictate the speed of backups. Supported type of instances: C5n (specific instance types in each class)"
  type = list(string)
  default = [
    "c5n.xlarge",
    "c5n.2xlarge"
